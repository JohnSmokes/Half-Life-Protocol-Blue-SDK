...
TYPEDESCRIPTION	CBasePlayer::m_playerSaveData[] = 
{
	...
	DEFINE_FIELD( CBasePlayer, m_bHasFlashlight, FIELD_BOOLEAN),
...
void CBasePlayer :: UpdateClientData( void )
{
	...
	// bacontsu - send flaslight data to client
	MESSAGE_BEGIN(MSG_ONE, gmsgCheckFlash, NULL, pev);
	WRITE_BYTE(m_bHasFlashlight);
	MESSAGE_END();
