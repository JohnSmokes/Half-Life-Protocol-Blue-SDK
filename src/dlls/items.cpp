...
// ==================================================================================
// Flashlight - obtainable flashlight entity (some kind of an upgrade) by Bacontsu
// ==================================================================================
class CItemFlashlight : public CItem
{
	...
	BOOL MyTouch(CBasePlayer* pPlayer)
	{
		...
		if (pPlayer->pev->weapons & (1 << WEAPON_SUIT) && !pPlayer->m_bHasFlashlight)
		{
			EMIT_SOUND(pPlayer->edict(), CHAN_ITEM, "items/gunpickup2.wav", 1, ATTN_NORM);
			pPlayer->m_bHasFlashlight = TRUE;
