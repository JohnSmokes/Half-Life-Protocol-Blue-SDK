...
int __MsgFunc_CheckFlash(const char* pszName, int iSize, void* pbuf) //bacontsu - flashlight
{
...
void CHud :: Init( void )
{
	...
	CVAR_CREATE("hud_red", "90", FCVAR_ARCHIVE);
	CVAR_CREATE("hud_green", "90", FCVAR_ARCHIVE);
